@echo off
setlocal
title PWA Nailul Muna - Jadwalkan Cron Snapshot Laporan
echo.
echo ============================================================
echo  Jadwalkan cron snapshot laporan ke Google Sheet (setiap 1 menit)
echo  Proyek: pwa_nailulmuna
echo ============================================================
echo.

set "PHP_EXE=C:\xampp\php\php.exe"
set "CRON_SCRIPT=C:\xampp\htdocs\pwa_nailulmuna\cron\laporan_snapshot.php"
set "TASK_NAME=PWA_NailulMuna_Laporan_Snapshot"
...
"%PHP_EXE%" "%CRON_SCRIPT%"
echo.
echo Aktifkan fitur di Pengaturan -^> Snapshot Laporan Google Sheet.
echo.
