...
ikhtibar_kerjakan_handle_post($pdo, $tugasId, $santriId, $tokenOk, [
    ...
    'hasil_detail' => app_href($base . '/hasil_detail.php?sesi_id='),

    'hasil_index' => app_href($base . '/index.php'),
...
if ($selesai):
    ...
    <?php if ($sesiSelesaiId > 0): ?>
        ...
        <a href="<?= htmlspecialchars(app_href($base . '/hasil_detail.php?sesi_id=' . $sesiSelesaiId)) ?>" class="btn btn-auth-primary w-100 mb-2"><i class="fa-solid fa-chart-simple me-1"></i> Lihat hasil &amp; nilai</a>

    <?php endif; ?>

    <a href="<?= htmlspecialchars(app_href($base . '/hasil.php')) ?>" class="btn btn-outline-secondary w-100 mb-2">Semua hasil tugas</a>

    <a href="<?= htmlspecialchars(app_href($base . '/index.php')) ?>" class="btn btn-link w-100 small">Daftar tugas</a>
...
<p class="text-center mt-3 mb-0"><a href="<?= htmlspecialchars(app_href($base . '/index.php')) ?>" class="small">← Daftar tugas</a></p>
