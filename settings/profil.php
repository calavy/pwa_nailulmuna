...
$st = $pdo->prepare('SELECT id, nama, username, role, foto_profil FROM users WHERE id = :id LIMIT 1');
...
<div class="page-intro mb-3">
    ...
    <p class="text-muted mb-0">Foto tampil di bilah atas dan daftar pengguna.</p>
</div>
