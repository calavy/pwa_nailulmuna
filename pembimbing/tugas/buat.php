        ...
        <div class="card-body">
            <div class="row g-2">
                <div class="col-md-6">
                    ...
                    <?php else: ?>
                        <div class="form-text">Sesuai kegiatan &amp; tingkatan yang Anda ampu di jadwal pondok.</div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
...
(function () {
    ...
    function renderEsai(n) {
        ...
        for (var i = 1; i <= n; i++) {
            ...
            html += '<input name="esai_kunci[' + i + ']" class="form-control form-control-sm" placeholder="Kunci / pedoman jawaban" value="' + esc(row.kunci_jawaban || '') + '">';
            html += '</div>';
        }
