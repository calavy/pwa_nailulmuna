...
<div class="page-intro mb-3">
    ...
    <p class="text-muted mb-0 small">Ringkasan kehadiran pembimbing dan munawib dalam satu dashboard.
        <a href="<?= htmlspecialchars(app_href('/rekap/pembimbing_kehadiran.php')) ?>">Lihat detail kehadiran per kegiatan</a>.
    </p>
</div>
