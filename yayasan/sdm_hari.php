...
<div class="yp-wrap">
    ...
    <div class="mt-3">
        <a class="btn btn-sm btn-outline-secondary" href="<?= htmlspecialchars(app_href('/yayasan/keaktifan.php?tanggal=' . urlencode($tanggal))) ?>">
            <i class="fa-solid fa-arrow-left me-1"></i>Kembali ke rekap keaktifan
        </a>
    </div>
</div>
