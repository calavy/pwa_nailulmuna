...
(function (global) {
    ...
    var PRESETS = {
        ...
        forest: ['#14532d', '#166534', '#22c55e', '#bbf7d0', '#86efac', 'rgba(20,83,45,.32)'],
        teal: ['#134e4a', '#0f766e', '#14b8a6', '#99f6e4', '#5eead4', 'rgba(19,78,74,.33)'],
        indigo: ['#312e81', '#4338ca', '#6366f1', '#c7d2fe', '#a5b4fc', 'rgba(49,46,129,.32)'],
        royal: ['#4c1d95', '#6d28d9', '#8b5cf6', '#ddd6fe', '#c4b5fd', 'rgba(76,29,149,.32)'],
        sunset: ['#9a3412', '#c2410c', '#f97316', '#fdba74', '#fb923c', 'rgba(154,52,18,.32)'],
        midnight: ['#0f172a', '#1e293b', '#334155', '#94a3b8', '#64748b', 'rgba(15,23,42,.35)'],
        coral: ['#9f1239', '#e11d48', '#fb7185', '#fecdd3', '#fda4af', 'rgba(159,18,57,.28)'],
        slate: ['#1e293b', '#334155', '#64748b', '#cbd5e1', '#94a3b8', 'rgba(30,41,59,.32)'],
        /* legacy keys → fallback terdekat */
        gold: ['#0f172a', '#1e293b', '#334155', '#94a3b8', '#64748b', 'rgba(15,23,42,.35)'],
        copper: ['#0f172a', '#1e293b', '#334155', '#94a3b8', '#64748b', 'rgba(15,23,42,.35)'],
        crimson: ['#312e81', '#4338ca', '#6366f1', '#c7d2fe', '#a5b4fc', 'rgba(49,46,129,.32)'],
        rose: ['#9f1239', '#e11d48', '#fb7185', '#fecdd3', '#fda4af', 'rgba(159,18,57,.28)'],
        navy: ['#1e3a8a', '#1d4ed8', '#0ea5e9', '#bfdbfe', '#93c5fd', 'rgba(30,64,175,.30)'],
        wine: ['#4c1d95', '#6d28d9', '#8b5cf6', '#ddd6fe', '#c4b5fd', 'rgba(76,29,149,.32)']
    };
