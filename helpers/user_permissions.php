...
function user_permission_path_map_base(): array
{
    return [
        ...
        '/pembimbing/tugas/hasil_nilai.php' => 'akademik_ikhtibar',
        ...
        '/akademik/nilai_ikhtibar.php' => 'akademik_ikhtibar',
        ...
        '/pembimbing/keaktifan_santri.php' => 'pembimbing_dashboard',
        ...
        '/rekap/alpa_santri_putra.php' => 'rekap',
        '/rekap/alpa_santri_putri.php' => 'rekap',
...
function user_permission_path_map_keuangan(): array
{
    ...
    $map = [
        ...
        '/keuangan/offline-data.php' => $laporan,
