...
function pondok_settings_defaults(): array
{
    return [
        ...
        'laporan_snapshot_enabled' => '0',
        'laporan_snapshot_jam' => '00:00',
        'laporan_snapshot_tab_titles' => '',
        'laporan_snapshot_cron_key' => '',
        'laporan_snapshot_share_emails' => '',
        ...
        'laporan_snapshot_last_share_date' => '',
        'google_calendar_enabled' => '0',
        'google_calendar_sa_json_path' => '',
        'google_calendar_id_internal' => '',
        'google_calendar_id_public' => '',
        'google_calendar_embed_public_url' => '',
        'google_calendar_cron_key' => '',
        'google_calendar_sync_token_internal' => '',
        'google_calendar_sync_token_public' => '',
        'google_calendar_last_sync_at' => '',
        'google_calendar_last_error' => '',
        'google_calendar_webhook_internal' => '',
        'google_calendar_webhook_public' => '',
...
function menu_tile_icon_for_path(string $path): string
{
    $exactIcons = [
        ...
        '/settings/laporan_snapshot.php' => 'fa-solid fa-table',
        '/settings/google_calendar.php' => 'fa-brands fa-google',
