                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="jam_mulai" id="jq-jam-mulai" class="form-control form-control-sm input-time-24" inputmode="numeric" pattern="^([01]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="HH:MM" maxlength="5" autocomplete="off" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Jam selesai</label>
                            <input type="text" name="jam_selesai" id="jq-jam-selesai" class="form-control form-control-sm input-time-24" inputmode="numeric" pattern="^([01]?[0-9]|2[0-3]):[0-5][0-9]$" placeholder="HH:MM" maxlength="5" autocomplete="off" required>
                        </div>
                        <div class="col-md-4">
