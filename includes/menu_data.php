...
return [
    'menuItems' => [
        ...
        '/keuangan/pengaturan.php?bagian=syahriyah_makan' => 'Syahriyah & PKPPS',
        ...
        '/settings/tingkatan.php#pkpps' => 'Tingkatan PKPPS',
        ...
        '/yayasan/dashboard.php' => 'Dashboard Yayasan',
    ...
    'menuStructure' => [
        ...
        ['type' => 'group', 'id' => 'menu-grp-keuangan', 'label' => 'Keuangan', 'icon' => 'fa-solid fa-wallet', 'sections' => [
            ...
            ['title' => 'Transaksi', 'paths' => [
                ...
                '/keuangan/riwayat_pengeluaran.php',
            ...
            ['title' => 'Pengaturan', 'paths' => [
                ...
                '/keuangan/pengaturan.php?bagian=syahriyah_makan',
        ...
        ['type' => 'group', 'id' => 'menu-grp-kajian', 'label' => 'Kajian', 'icon' => 'fa-solid fa-book-open', 'sections' => [
            ...
            ['title' => 'Akademik', 'paths' => [
                ...
                '/akademik/setoran_dashboard.php',
                '/akademik/bait_kitab.php',
                '/akademik/hafalan.php',
                '/akademik/setoran_rekap.php',
                '/akademik/setoran_rekap_kitab.php',
                '/akademik/setoran_penerima.php',
                '/pembimbing/setoran_dashboard.php',
        ...
        ['type' => 'group', 'id' => 'menu-grp-yayasan', 'label' => 'Yayasan', 'icon' => 'fa-solid fa-building-columns', 'sections' => [
            ['title' => 'Dashboard & Operasional', 'paths' => [
                '/yayasan/operasional.php',
                '/yayasan/pengawasan.php',
                '/yayasan/ringkasan.php',
            ]],
            ['title' => 'Keaktifan & Ketertiban', 'paths' => [
                '/yayasan/keaktifan.php',
                '/yayasan/ketertiban.php',
            ]],
            ['title' => 'Struktural & Rapat', 'paths' => [
                '/yayasan/timeline.php',
    ...
    'pengaturanNav' => [
        ...
        ['path' => '/settings/kalender.php', 'label' => 'Kalender & Tagihan', 'icon' => 'fa-solid fa-calendar-days', 'group' => 'Umum'],
        ['path' => '/settings/peraturan.php', 'label' => 'Peraturan Poin', 'icon' => 'fa-solid fa-scale-balanced', 'group' => 'Umum'],
        ['path' => '/settings/wa_otomatis.php', 'label' => 'Pusat WA Otomatis', 'icon' => 'fa-solid fa-comments', 'group' => 'WhatsApp'],
        ['path' => '/settings/wa_gateway.php', 'label' => 'WA Gateway', 'icon' => 'fa-solid fa-gears', 'group' => 'WhatsApp'],
