...
/** @var list<array<string, mixed>> $ringkasanPos */
/** @var bool $tablesOk */

?>
<div class="alert alert-light border small mb-3 py-2">
    <strong>Tagihan s.d. <?= htmlspecialchars((string) ($berjalan['periode_tampilan'] ?? $berjalan['bulan_label'] ?? '')) ?></strong>
    (TA <?= htmlspecialchars((string) ($berjalan['ta_label'] ?? '')) ?>):
    <?php if ((int) ($tagihanKumulatif['sisa_total'] ?? 0) > 0): ?>
        sisa <span class="text-danger fw-semibold">Rp <?= number_format((int) $tagihanKumulatif['sisa_total'], 0, ',', '.') ?></span>
    <?php else: ?>
        <span class="text-success fw-semibold"><?= htmlspecialchars((string) ($tagihanKumulatif['status'] ?? 'Lunas')) ?></span>
    <?php endif; ?>
    · <a href="<?= htmlspecialchars(app_href('/wali/keuangan.php?tab=tagihan')) ?>">Detail per bulan</a>
</div>
