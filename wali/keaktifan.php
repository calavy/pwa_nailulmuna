...
$penilaianBulanRow = is_array($keaktifanPenilaianBulan['row'] ?? null) ? $keaktifanPenilaianBulan['row'] : null;
...
?>
        ...
        $waliKeaktifanPenilaianCompact = false;
        ...
        <?php else: ?>
            <div class="wali-hero mb-3">
                <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                    <div class="small text-muted mb-0">Ringkasan <?= htmlspecialchars((string) $bulanFilter['label']) ?></div>
                    <?php if ($penilaianBulanRow): ?>
                        <?php
                        $heroLabel = (string) ($penilaianBulanRow['label'] ?? '—');
                        $heroBadge = santri_riwayat_keaktifan_badge_class($heroLabel);
                        ?>
                        <span class="badge <?= htmlspecialchars($heroBadge) ?>"><?= htmlspecialchars($heroLabel) ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="small text-muted mt-2 text-center">
                    ...
                    <?php if ($penilaianBulanRow): ?>
                        · Kategori: <strong><?= htmlspecialchars((string) ($penilaianBulanRow['label'] ?? '—')) ?></strong>
                    <?php endif; ?>
                </div>
            </div>
