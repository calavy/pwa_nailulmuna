...
$checks = [
    ...
    'format_uses_kali_alpa' => str_contains($daftar, 'kali ALPA'),
    'format_no_total_hari' => !str_contains($daftar, '(Total:') && !preg_match('/\d+\s+hari\)/', $daftar),
    'format_has_nis' => str_contains($daftar, '(NIS 001)'),
