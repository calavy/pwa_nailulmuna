...
<div class="card shadow-sm mt-4 border-info">
    ...
    <div class="card-body small text-muted">
        ...
        <p class="mb-2"><strong>Kartu pembayaran santri</strong> (<a href="<?= htmlspecialchars(app_href('/pembayaran/kartu_syahriyah_santri.php')) ?>">cari santri</a>): bagian PKPPS masuk
