...
$modulOptions = [
    ...
    OPERASIONAL_AUDIT_MODUL_KEUANGAN_PEMASUKAN => operasional_audit_modul_label(OPERASIONAL_AUDIT_MODUL_KEUANGAN_PEMASUKAN),
    OPERASIONAL_AUDIT_MODUL_KEUANGAN_PENGELUARAN => operasional_audit_modul_label(OPERASIONAL_AUDIT_MODUL_KEUANGAN_PENGELUARAN),
    ...
    <div class="table-responsive">
        <table class="table table-sm table-striped align-middle mb-0">
            ...
            <?php foreach ($logs as $log): ?>
                ...
                } elseif ($modul === OPERASIONAL_AUDIT_MODUL_KEUANGAN_PEMASUKAN) {
                    $rowR = is_array($sesudah) && $sesudah !== [] ? $sesudah : (is_array($sebelum) ? $sebelum : null);
                    $ringkas = operasional_audit_ringkas_pemasukan($rowR);
                } elseif ($modul === OPERASIONAL_AUDIT_MODUL_KEUANGAN_PENGELUARAN) {
                    $rowR = is_array($sesudah) && $sesudah !== [] ? $sesudah : (is_array($sebelum) ? $sebelum : null);
                    $ringkas = operasional_audit_ringkas_pengeluaran($rowR);
                ...
                <tr>
                    ...
                    <td class="text-end text-nowrap">
                        <?php if (in_array($modul, operasional_audit_kas_moduls(), true) && $aksi === 'DELETE' && !operasional_audit_is_restored($log)): ?>
                            <a class="btn btn-sm btn-outline-success" href="<?= htmlspecialchars(app_href('/keuangan/perbaikan-kas.php#riwayat-hapus')) ?>">Pulihkan</a>
                        <?php elseif ($modul === OPERASIONAL_AUDIT_MODUL_KEUANGAN && $eid > 0 && $aksi !== 'DELETE'): ?>
